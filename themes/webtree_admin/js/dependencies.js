(function($){
    ...
    var webtreeDependenciesParse = function(dependencies, checked, name) {
    ...
    var webtreeDependenciesInit = function(cx, s) {
        ...
        $('input[data-dependencies]').change(function(){
            ...
            webtreeDependenciesParse(dependencies, checked, name);
        });
    ...
    Drupal.behaviors.webtreeDependencies = {
        attach: webtreeDependenciesInit
    }
